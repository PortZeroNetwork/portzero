...
_Note: commits for this work carry the slug `task-82` — the slug was reassigned to task-83 after a parallel-worktree collision (task-82 = glibc release ticket)._
